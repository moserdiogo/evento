...
<!-- page-header -->
    <div class="venue-pageheader" style="background-image: url('https://jituchauhan.com/real-wed/realwed/images/venue-pageheader.jpg');">
        <div class="container">
            <div class="row align-items-end page-section">
                <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                    <div class="">
                        <h1 class="vendor-heading">Heading Title for Wedding Vendor Business</h1>
                        <p class="text-white"><span class="mr-2"><i class="fas fa-map-marker-alt "></i></span>3170 Stonecoal Road Napoleon, OH 43545 <a href="#view-map" class="btn-default-link">view map</a></p>
                    </div>
                </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-7 col-sm-12 col-12">
                    ...
                    <div class="mt20">
                        <div class="card border card-shadow-none">
                            <h3 class="card-header bg-white">Descrição</h3>
                            <div class="card-body">
                                <!--/.vendor-details -->
                                <p><?php echo $parceiro[0]->descricao ?></p>
                                <!--venue-highlights -->
                                    ...
                                    <div class=" table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1-100 Pessoas</td>
                                                    <td class="venue-highlight-meta"><?php echo $parceiro[0]->valor_100 ?></td>
                                                </tr>
                                                <tr>
                                                    <td>1-200 Pessoas</td>
                                                    <td class="venue-highlight-meta"><?php echo $parceiro[0]->valor_200 ?></td>
                                                </tr>
                                                <tr>
                                                    <td>1-300 Pessoas</td>
                                                    <td class="venue-highlight-meta"><?php echo $parceiro[0]->valor_300 ?></td>
                                                </tr>
                                                <tr>
                                                    <td>1-400 Pessoas</td>
                                                    <td class="venue-highlight-meta"><?php echo $parceiro[0]->valor_400 ?></td>
                                                </tr>
                                                <tr>
                                                    <td>1-500 Pessoas</td>
                                                    <td class="venue-highlight-meta"><?php echo $parceiro[0]->valor_500 ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <!-- aminities-block -->
                        <div class="card border card-shadow-none">
                            <h3 class="card-header bg-white">Serviços inclusos</h3>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="list-single-carousel">
                            <div class="owl-carousel owl-theme owl-slider">
                                <div class="item">
                                    <img src="<?php echo base_url() ?>public/img/decoracao/download.jpg" alt="">
                                </div>
                                <div class="item">
    ...
    <script src="https://jituchauhan.com/real-wed/realwed/js/owl.carousel.min.js"></script>