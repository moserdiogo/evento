<!-- footer-section -->
    ...
    <script src="<?php echo base_url(); ?>public/js/custom-script.js"></script>
    ...
    <script src="<?php echo base_url(); ?>public/js/nice-select.js"></script>
    <script src="<?php echo base_url(); ?>public/js/off-canvas.js"></script> 
    <script src="<?php echo base_url(); ?>public/js/return-to-top.js"></script>
    <script src="<?php echo base_url(); ?>public/js/vendor.bundle.base.js"></script>
